...
type
  TMainForm = class(TForm)
    ...
    BitBtn21: TBitBtn;
    BitBtn22: TBitBtn;
    procedure BTypeFСhBClick(Sender: TObject);
...
procedure TMainForm.BTypeFСhBClick(Sender: TObject);
begin
  ReloadBoats;
end;
...
begin
  ...
  try
    ...
    if (BTypeFСhB.Checked and (ConnectionDM.BoatTypesADOT.RecordCount>0)) or
     ...
     ' WHERE ';
    if (BTypeFСhB.Checked and (ConnectionDM.BoatTypesADOT.RecordCount>0)) then
    begin
     ConnectionDM.BoatsADODS.CommandText:=ConnectionDM.BoatsADODS.CommandText+
    ...
    ShowMessage('Ошибка перезагрузки таблицы судов! Описание: '+E.Message);
  end;
end;
...
begin
  ...
  try
    ...
    ShowMessage('Ошибка перезагрузки таблицы клиентов! Описание: '+E.Message);
  end;
end;
...
begin
  ...
  try
    ...
    ShowMessage('Ошибка перезагрузки таблицы заказов! Описание: '+E.Message);
  end;
end;
...
begin
  try
    ...
    ShowMessage('Ошибка перезагрузки справочника клиентов! Описание: '+E.Message);
  end;
end;
...
begin
  try
    ...
    ShowMessage('Ошибка перезагрузки справочника типов судов! Описание: '+E.Message);
  end;
end;
...
begin
  try
    ...
    ShowMessage('Ошибка перезагрузки справочника стоянок! Описание: '+E.Message);
  end;
end;
...
begin
  try
    ...
    ShowMessage('Ошибка перезагрузки справочника типов клиентов! Описание: '+E.Message);
  end;
end;
...
begin
  try
    ...
    ShowMessage('Ошибка перезагрузки справочника работников! Описание: '+E.Message);
  end;
end;
...
begin
  try
    ...
    ShowMessage('Ошибка перезагрузки справочника судов! Описание: '+E.Message);
  end;
end;
